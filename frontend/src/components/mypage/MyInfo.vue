<template>
    <div class="my__info__wrapper">
        <div class="avatar">
            <img src="/src/assets/icons/default_profile_image.png" alt="" />
            <label for="profile_input" class="profile__edit__btn">
                <PencilSvg :size="'2rem'" />
                <input
                    type="file"
                    id="profile_input"
                    @change="(e) => fileUploadHandler(e as InputEvent)"
                />
            </label>
        </div>
        ...
        <div class="btn__wrapper">
            <button v-if="!editMode" class="my__info__btn" @click="editModeOpenHandler">
                Edit profile
            </button>
