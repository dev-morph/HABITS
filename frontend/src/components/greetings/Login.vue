<template>
    <section class="signup__wrapper">
        <div class="signup__logo">
            <img src="/src/assets/icons/habit_nobackground.png" alt="signup_logo" />
        </div>
        ...
        <div class="btn__wrapper">
            <Transition name="display" mode="out-in">
                <div class="prevStageBtn" v-if="currentStage >= 1" @click="goPreviousStage">
                ...
                try {
                    ...
                    if (error instanceof AxiosError) {
                        if (error.response?.status === 401) {
                            ...
                            errorMsg.value =
                                '백엔드 서버가 불안정 합니다. 잠시 후 다시 시도해주세요.'
                        }
                    }
                }
            }
